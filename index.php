...
<body>
    ...
    <footer id="contatos">
        <div id="footer_content">
            ...
            <div id="footer_contacts">
                ...
                <div id="footer_social_media">
                    <a href="#" class="footer-whats" id="whatsapp"><i class="fa-brands fa-whatsapp"></i></a>
                </div>
            </div>
        </div>
        ...
        <div id="footer_copyright">
            <div id="footer_terms">
                <div id="footer_copy">
                    <a href="#" class="footer-link" id="termos">Termos de Uso</a>
                    <a href="#" class="footer-link" id="termos">Política de Privacidade</a>
                </div>
            </div>

            <p>&copy;<span id="ano"></span> Tapetes da Carlinha. Todos os direitos reservados.</p>
        </div>
    </footer>
